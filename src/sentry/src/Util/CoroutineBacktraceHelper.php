...
class CoroutineBacktraceHelper
{
    ...
    protected static array $breakFunctions = [
        ...
        'FriendsOfHyperf\Sentry\Transport\CoHttpTransport->FriendsOfHyperf\Sentry\Transport\{closure}',
        'FriendsOfHyperf\Sentry\Metrics\Listener\OnBeforeHandle->process',
        'FriendsOfHyperf\Sentry\Metrics\Listener\OnMetricFactoryReady->process',
        'FriendsOfHyperf\Sentry\Metrics\Listener\QueueWatcher->process',
