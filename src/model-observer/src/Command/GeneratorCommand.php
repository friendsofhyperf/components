...
class GeneratorCommand extends SymfonyCommand
{
    ...
    {
        parent::__construct('gen:observer');
    ...
    protected function replaceModel(&$stub)
    {
        $stub = str_replace(
            ['%USE_MODEL%', '%MODEL%'],
            [$this->getModelInput(), basename(str_replace('\\', '/', $this->getModelInput()))],
            $stub
        );
    ...
    {
        return trim($this->input->getOption('model'));
    }
    ...
    protected function getOptions()
    {
        return [
            ...
            ['model', 'M', InputOption::VALUE_REQUIRED, 'The model for observer.', null],
    ...
    {
        $key = 'devtool.generator.observer';
