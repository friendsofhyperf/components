...
<template>
    <index-screen title="Exceptions" resource="exceptions">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit text-right text-muted" :data-timeago="slotProps.entry.created_at"
                :title="slotProps.entry.created_at">
                {{ timeAgo(slotProps.entry.created_at) }}
            </td>

            <td class="table-fit">
                <div v-if="slotProps.entry.content.resolved_at" :data-timeago="slotProps.entry.content.resolved_at"
