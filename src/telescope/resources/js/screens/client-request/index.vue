...
<template>
    <index-screen title="Client Request" resource="client-request">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <span class="badge"
                    :class="'badge-' + requestStatusClass(slotProps.entry.content.response_status !== undefined ? slotProps.entry.content.response_status : null)">
                    {{ slotProps.entry.content.response_status !== undefined ? slotProps.entry.content.response_status :
                        'N/A' }}
                </span>
            </td>
            ...
            <td class="table-fit">
                <router-link :to="{ name: 'client-request-preview', params: { id: slotProps.entry.id } }"
