export default [
...

    {
        path: '/services',
        name: 'services',
        component: require('./screens/services/index').default,
    },
    {
        path: '/services/:id',
        name: 'services-preview',
        component: require('./screens/services/preview').default,
    },
    {
        path: '/client-request',
        name: 'client-request',
        component: require('./screens/client-request/index').default,
    },
    {
        path: '/client-request/:id',
        name: 'client-request-preview',
        component: require('./screens/client-request/preview').default,
    }
];
