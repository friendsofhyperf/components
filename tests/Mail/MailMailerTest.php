...
class MailMailerTest extends TestCase
{
    ...
    public function testMailerSendsHtmlStringsWithoutCallbacks(): void
    {
        $view = m::mock(Factory::class);
    ...
    public function testMailerSendsHtmlableContent(): void
    {
        $view = m::mock(Factory::class);
        $view->shouldNotReceive('make');
        $mailer = new Mailer('array', $view, new ArrayTransport());
    ...
    public function testMailerRendersHtmlStringContent(): void
    {
        $view = m::mock(Factory::class);
        $view->shouldNotReceive('make');
        $mailer = new Mailer('array', $view, new ArrayTransport());
    ...
    public function testMailerSendsMailableWithHtmlStringContent(): void
    {
        $view = m::mock(Factory::class);
        $view->shouldNotReceive('make');
