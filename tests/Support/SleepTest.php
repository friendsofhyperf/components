...
test('test ItSleepsForSeconds', function () {
...
test('test ItSleepsForSecondsWithMilliseconds', function () {
    $start = microtime(true);
...
test('test ItCanFakeSleeping', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMinutes', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMinute', function () {
    Sleep::fake();
...
test('test ItCanSpecifySeconds', function () {
    Sleep::fake();
...
test('test ItCanSpecifySecond', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMilliseconds', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMillisecond', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMicroseconds', function () {
    Sleep::fake();
...
test('test ItCanSpecifyMicrosecond', function () {
    Sleep::fake();
...
test('test ItCanChainDurations', function () {
    Sleep::fake();
...
test('test ItCanUseDateInterval', function () {
    Sleep::fake();
...
test('test ItThrowsForUnknownTimeUnit', function () {
    try {
        Sleep::for(5);
        $this->fail();
...
test('test ItCanAssertSequence', function () {
    Sleep::fake();
...
test('test ItFailsSequenceAssertion', function () {
    Sleep::fake();
...
test('test ItCanUseSleep', function () {
    Sleep::fake();
...
test('test ItCanUseUSleep', function () {
    Sleep::fake();
...
test('test ItCanSleepTillGivenTime', function () {
    Sleep::fake();
...
test('test ItCanSleepTillGivenTimestamp', function () {
    Sleep::fake();
    Carbon::setTestNow(now()->startOfDay());
...
test('test ItCanSleepTillGivenTimestampAsString', function () {
    Sleep::fake();
    Carbon::setTestNow(now()->startOfDay());
...
test('test ItCanSleepTillGivenTimestampAsStringWithMilliseconds', function () {
    Sleep::fake();
...
test('test ItSleepsForZeroTimeWithNegativeDateTime', function () {
    Sleep::fake();
    Carbon::setTestNow(now()->startOfDay());
...
test('test SleepingForZeroTime', function () {
    Sleep::fake();
...
test('test ItFailsWhenSequenceContainsTooManySleeps', function () {
    Sleep::fake();
...
test('test SilentlySetsDurationToZeroForNegativeValues', function () {
    Sleep::fake();
...
test('test ItDoesntCaptureAssertionInstances', function () {
    Sleep::fake();
...
test('test AssertNeverSlept', function () {
    Sleep::fake();
...
test('test AssertNeverAgainstZeroSecondSleep', function () {
    Sleep::fake();
...
test('test ItCanAssertNoSleepingOccurred', function () {
    Sleep::fake();
...
test('test ItCanAssertSleepCount', function () {
    Sleep::fake();
...
test('test AssertSlept', function () {
    Sleep::fake();
...
test('test ItCanCreateMacrosViaMacroable', function () {
    Sleep::fake();
...
test('test ItCanReplacePreviouslyDefinedDurations', function () {
    Sleep::fake();
...
test('test ItCanSleepConditionallyWhen', function () {
    Sleep::fake();
...
test('test ItCanRegisterCallbacksToRunInTests', function () {
    $countA = 0;
    $countB = 0;
    Sleep::fake();
...
test('test ItDoesntRunCallbacksWhenNotFaking', function () {
