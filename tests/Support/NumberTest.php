...
beforeEach(function () {})->skip(! extension_loaded('intl'));
...
test('test FormatWithDifferentLocale', function () {
...
test('test FormatWithAppLocale', function () {
    $this->assertSame('123,456,789', Number::format(123456789));
...
test('test ToCurrencyWithDifferentLocale', function () {
...
test('test BytesToHuman', function () {
